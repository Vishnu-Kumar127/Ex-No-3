...
public class software {
    public static void main(String[] args) {
        ...
        b=o.next();
        System.out.print("Enter Blue Book Value:");
        c=o.nextFloat();
        System.out.print("Enter making Year:");
        d=o.nextInt();
        System.out.print("Enter No of passenger:");
        e=o.nextInt();
        System.out.println("Car Details:");
        System.out.print("Do you have warranty (True or Flase):");
        f=o.nextBoolean();
        System.out.print("Whether car Imported (True or Flase):");
        g=o.nextBoolean();
        ...
        j=o.next();
        System.out.print("Enter model of reardoor:");
        k=o.next();
        System.out.println("Truck Details:");
        System.out.print("Whether have Topper (True or Flase):");
        l=o.nextBoolean();
        
        System.out.print("Enter Name of Wheels:");
        m=o.next();
